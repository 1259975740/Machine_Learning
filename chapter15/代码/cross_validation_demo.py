# -*- coding: utf-8 -*-
"""
Created on Wed Mar 25 21:03:46 2020
...
S_knn = cross_val_score(knn,X,y,scoring=acc_scorer,cv=10)   #10折交叉验证，通过scoring参数设置评价模型的拟合优度，cv为K的值。
S_lg = cross_val_score(lg,X,y,scoring=acc_scorer,cv=10)   
